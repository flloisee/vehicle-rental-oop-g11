...
CREATE TABLE `Rentals` (
  ...
  KEY `rental-customer_idx` (`customerID`),
  KEY `rental-vehicle_idx` (`vehicleID`),
  CONSTRAINT `rental-customer` FOREIGN KEY (`customerID`) REFERENCES `Customers` (`customerID`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
-- Dump completed on 2026-06-13 10:39:21
